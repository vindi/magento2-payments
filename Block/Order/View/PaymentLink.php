<?php
namespace Vindi\VP\Block\Order\View;

/**
 * Class PaymentLink
 * @package Vindi\VP\Block\Order\View
 */
class PaymentLink extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Vindi_VP::order/view/paymentlink.phtml';
    ...
    /**
     * @var \Vindi\VP\Model\PaymentLinkService
     */
     ...
     * @param \Vindi\VP\Model\PaymentLinkService $paymentLinkService
     * @param array $data
     */
    public function __construct(
        ...
        \Vindi\VP\Model\PaymentLinkService $paymentLinkService,
        array $data = []
    ) {
