...
use Vindi\VP\Api\Data\CallbackInterfaceFactory;
use Vindi\VP\Api\Data\CallbackSearchResultsInterfaceFactory;
use Vindi\VP\Api\CallbackRepositoryInterface;
use Vindi\VP\Model\ResourceModel\Callback as ResourceCallback;
use Vindi\VP\Model\ResourceModel\Callback\CollectionFactory as CallbackCollectionFactory;
...
class CallbackRepository implements CallbackRepositoryInterface
{
    ...
    public function save(
        \Vindi\VP\Api\Data\CallbackInterface $callback
    ) {
        try {
    ...
    public function getList(
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \Vindi\VP\Api\Data\CallbackInterface::class
        );
